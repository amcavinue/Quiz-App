...
/***/ function(module, exports, __webpack_require__) {
	...
	// Custom modules.
	var questionProcessing = __webpack_require__(2);
	var domOutput = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var questionProcessing = {
	     ...
	     */
	    getQuestion: function getQuestion(state, questions) {
	     ...
	     */
	    updateScore: function updateScore(state) {
	     ...
	     * @param {array} questions
	     */
	    getResults: function getResults(state, questions) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var domOutput = {
	    closingStatement: function closingStatement(state) {
	        if (state.correct === 5) {
	    ...
	    renderQuestion: function renderQuestion(state, qAndA) {
	        return '<section class="question">' + '<div class="question-content">' + '<span class="question-num">Q' + (state.questionNum + 1) + '.</span>' + '<h2>' + qAndA.question + '</h2>' + '<ul class="js-answers">' + '<li>' + '<span class="checkbox" data-question="a"></span>' + 'a. ' + qAndA.a + '</li>' + '<li>' + '<span class="checkbox" data-question="b"></span>' + 'b. ' + qAndA.b + '</li>' + '<li>' + '<span class="checkbox" data-question="c"></span>' + 'c. ' + qAndA.c + '</li>' + '<li>' + '<span class="checkbox" data-question="d"></span>' + 'd. ' + qAndA.d + '</li>' + '</ul>' + '<div class="answer-section">' + '</div>' + '</div>' + '</section>' + '<hr />';
	    },
	    renderResults: function renderResults(state) {
	        return '<section class="results">' + '<h2>You finished the quiz!</h2>' + '<p class="result-stats">' + 'You Got <strong><span class="js-correct-num">' + state.correct + '</span>/5 Correct</strong>' + '</p>' + '<p class="closing-statement">' + this.closingStatement(state) + '</p>' + '<a href="#" class="replay js-replay">PLAY AGAIN</a>' + '</section>';
	    }
	};
